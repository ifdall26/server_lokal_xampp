...
$title = "Tambah User - SMKN 5 Padang";
                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="mb-3 row">
                                ...
                                <input type="text" pattern= "[A-Za-z0-9]{3,}" title="minimal 3 karakter kombinasi huruf besar kecil dan angka" class="form-control border-0 border-bottom" id="username" name= "username" maxlength="20" required>
                                </div>
                            </div>
                            <div class="mb-3 row">
                        ...
                        <small>Pilih foto PNG, JPG, atau JPEG dengan ukuran maksimal 1 MB</small>
