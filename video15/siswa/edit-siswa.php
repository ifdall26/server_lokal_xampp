...
$title = "Update Siswa - SMKN 5 Padang";
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom" required>
                                        <?php
                                            $jurusan = ["Bisnis Konstruksi dan Properti","Desain Pemodelan dan Informasi Bangunan","Teknik Instalasi Tenaga Listrik","Teknik Pemesinan","Teknik Kendaraan Ringan Otomotif","Teknik dan Bisnis Sepeda Motor","Teknik Audio Video","Teknik Komputer dan Jaringan"];
                        ...
                        <div class="col-4 text-center px-5">
                            ...
                            <div><small class="text-scondary">width = height</small></div>
