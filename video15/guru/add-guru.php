...
$title = "Tambah Guru - SMK 5 Padang";
...
if ($msg== 'oversize') {
    $alert='<div class="alert alert-warning alert-dismissible fade show" role="alert">
    <i class="fa-solid fa-xmark"></i> Tambah guru gagal, maksimal ukuran gambar 1 MB...
    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
  </div>';
}
if ($msg== 'added') {
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <input type="tel" name="telepon" pattern="[0-9]{5,}" title="minimal 18 angka" class="form-control ps-2 border-0 border-bottom" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9" style="margin-left: -50px;">
                                    <select name="agama" id="agama" class="form-select border-0 border-bottom" requiired>
